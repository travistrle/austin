...
// Validate the Todo in the database
    ...
    companion object {
        ...
        fun createEntity(em: EntityManager): Todo {
            ...
            if (findAll(em, OneGridUser::class).isEmpty()) {
                oneGridUser = OneGridUserResourceIT.createEntity(em)
                em.persist(oneGridUser)
                em.flush()
            } else {
                oneGridUser = findAll(em, OneGridUser::class)[0]
            }
            todo.users?.add(oneGridUser)
            return todo
        }
        ...
        fun createUpdatedEntity(em: EntityManager): Todo {
            ...
            val oneGridUser: OneGridUser
            if (findAll(em, OneGridUser::class).isEmpty()) {
                oneGridUser = OneGridUserResourceIT.createUpdatedEntity(em)
                em.persist(oneGridUser)
                em.flush()
            } else {
                oneGridUser = findAll(em, OneGridUser::class)[0]
