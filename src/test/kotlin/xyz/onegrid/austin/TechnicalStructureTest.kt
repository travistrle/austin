...
@AnalyzeClasses(packagesOf = [AustinApp::class], importOptions = [DoNotIncludeTests::class])
class TechnicalStructureTest {
    ...
    val respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(AustinApp::class.java), alwaysTrue())
        .ignoreDependency(
            alwaysTrue(),
            belongToAnyOf(
                xyz.onegrid.austin.config.ApplicationProperties::class.java
            )
        )
}
